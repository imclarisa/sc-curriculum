...
In JavaScript, scopes are created by code blocks and modules, like in a function. A variable defined inside a scope is accessible only within that scope, but inaccessible outside of it.
