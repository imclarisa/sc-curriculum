...
In JavaScript, scopes are created by code blocks and modules, like in a function. If an embedded function is created, a variable created in the parent function is available to be used in the child function. A variable defined inside a scope (whether it is the parent or child) is accessible within that scope, but inaccessible outside of it.
