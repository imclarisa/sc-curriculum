...
<br>
Primitive Data Types refers to all pieces of data you will see in the JavaScript environment. You can create a collection of these pieces of data by grouping them as objects.
</br>
- JS Arrays, array length, array keys, indexing, and the `for...of` (array) loop
<br>
JS Arrays are a collection of data. Each piece of data inside the array has a specific location, known as the index.
In a `for ... of` loop you identify each individual piece of data in an array. You can then give directions to the computer what you want it to do at each index value.
</br>
- JS Objects, key-value pairs, and Accessing Object Properties
<br>
JS Objects are also a collection of data. They are different, however, in that each piece of data is written as a key-value pair. Doing this allows you to identify a particular piece of information inside the object, known as Accessing Object Properties.
</br>
