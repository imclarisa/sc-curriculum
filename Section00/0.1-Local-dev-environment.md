...
> **For fully detailed steps and instructions (with images) on setting up an SSH key for GitHub see [Section00\0.1.1-GitHub_SSH_Key.md](0.1.1-GitHub_SSH_Key.md)**
