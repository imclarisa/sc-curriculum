...
![Basic Pre-SPA File Structure](Resources/img/basic-pre-SPA-file-structure.png)
...
![Pre-SPA File Structure](Resources/img/Pre-SPA.png)
...
While more files might sound just as hard to manage, additional files used for SPA are contained within one of three new folders: `components`, `store`, and / or even maybe possibly a `lib` folder.

![Basic SPA File Structure](Resources/img/basic-SPA-file-structure.png)
...
- **`lib`** represents an _optional_ **lib**rary of _JS modules_ which _export_ Functions, Classes, Objects, or Arrays that we might maybe possibly want to use in any of our "main" (`components`, `store`, `index.js`) JavaScript files.
