...
- CLI
<br>
The Command Line Interface is the way a developer navigates through a computer's file structure. Opening files in this way makes using applications in the development environment easier.
</br>
- npm
<br>
Node Package Manager is a collection of packages that help you to create a development environment.
</br>
- VS Code
<br>
Visual Studio is the program you will be using in this class to create pages of code. Opening this application is done through the Command Line Interface.
</br>
- Markdown
<br>
This is a language that you will often see in a development environment. A file that has the suffix .md is written in this way.
</br>
- git
<br>
GitBash refers to the Command Line Interface. This is on your computer. When you want your code to be seem on GitHub, you must use git commands to push up these changes.
</br>
