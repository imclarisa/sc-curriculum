...
1. Use the [Savvy-Coders Starter template repo](https://github.com/savvy-coders/savvy-starter) to _create a new GitHub repo for homework_ - name it something that indicates it is for **Savvy Coders Homework**
