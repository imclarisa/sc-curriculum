...
5. In the `Week2` folder, create a new file called `2.3.5-MoreIfElseStatements.js`
...
if ( ) {
  ...
  // finish the statement with the only 3 remaining numbers not yet tested for at this point in the statement
  console.log("The number is one of these three numbers: X, Y, Z.")
}
```
