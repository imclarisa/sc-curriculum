...
<br>
When you instantiate a variable, you can compare the variable to another value. This is useful when you need (or don't need) a specific value to correctly complete a function in a project.
</br>
- Data Coercion
- Flow control statements and loops
<br>
This uses the comparison operators previously learned to evaluate a statement as being true or false. You can then quickly complete a function as long as the statement evaluates to true.
</br>
