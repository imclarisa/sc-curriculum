...
4. To access our environment variables in a JS file, we need to `import` dotenv, then call the config method on dotenv.  Then we can access our environment variables from the `process.env` Object.
