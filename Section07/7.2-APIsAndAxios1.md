...
7. It is important to make sure that the information is collected from the API before formatting it. Add this information to the hooks method
...
8. Go to 'views/Home.js' and import this information so it is displayed on your HomePage. Remember to call state in your default export function.
