...
<br>
You can more easily access the data for your web application when it is stored in an object structure.
</br>
- Methods and `this`
<br>
Inside the object structure functions can be created, referred to as methods. Inside these methods you are able to access the data set in the object structure you created using the `this` keyword.
</br>
- Creating Objects with `function` Constructors
<br>
Object Oriented Programming as previously described is useful when dealing with a single entity. If you wish to create a category of objects (such as descriptions of available sweaters from a store's web application), having a template to add to is very useful. That is where having a function constructor is useful.
</br>
