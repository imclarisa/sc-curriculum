...
## While you are working, you can see what is printed to the console by typing `node 4.3.2-Map.js` in the terminal

## When this activity is finished, push your work up to GitHub

1. Type `git add 4.3.2-Map.js` in your terminal
2. Type `git status`
3. Type `git commit -m "Map"`
4. Type `git status`
5. Type `git push`
