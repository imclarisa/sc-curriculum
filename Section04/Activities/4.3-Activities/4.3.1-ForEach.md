...
## While you are working, you can see what is printed to the console by typing `node 4.3.1-ForEach.js` in the terminal

## When this activity is finished, push your work up to GitHub

1. Type `git add 4.3.1-ForEach.js` in your terminal
2. Type `git status`
3. Type `git commit -m "For Each"`
4. Type `git status`
5. Type `git push`
